...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { nome: @curso.nome, periodo: @curso.periodo, valor_inscricao: @curso.valor_inscricao }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { nome: @curso.nome, periodo: @curso.periodo, valor_inscricao: @curso.valor_inscricao }
    assert_redirected_to curso_path(assigns(:curso))
  end
